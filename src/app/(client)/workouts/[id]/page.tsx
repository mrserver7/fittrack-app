  ...
  return (
    <div className="page-container max-w-2xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-foreground">{formatDate(log.scheduledDate)}</h1>
          <p className="text-sm text-muted-foreground">{log.workoutDay?.dayLabel || "Free session"}</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        ...
        <div className="section-card p-4 text-center">
          <p className="text-lg font-bold text-foreground">{log.avgRpe ? log.avgRpe : "---"}</p>
