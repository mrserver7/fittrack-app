...
export default function AccountForm({ currentEmail }: AccountFormProps) {
  ...
  return (
    <div className="space-y-8">
      {/* Email section */}
      <div>
        <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-50 mb-4">{t.settings.changeEmail}</h3>
      ...
      <div className="border-t border-gray-100 dark:border-gray-800 pt-6">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-50 mb-4">{t.settings.changePassword}</h3>
